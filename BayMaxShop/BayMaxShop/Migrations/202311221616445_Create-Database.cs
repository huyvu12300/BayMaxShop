namespace BayMaxShop.Migrations
{
    ...
    public partial class CreateDatabase : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_Wishlist", "UserID", "dbo.AspNetUsers");
            ...
            DropForeignKey("dbo.tb_AddressBook", "UserID", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.tb_Wishlist", new[] { "UserID" });
            ...
            DropIndex("dbo.tb_AddressBook", new[] { "UserID" });
